...
<body>
	...
	<section class="mostruario">
		...
		<div class="vitrine">
			...
			<a href="pgCompra.html">
				<figure class="itens">

					<div class="img-item">
						<img src="imagens/produtos/moletons/Animes/Killua - unissex.png">
					</div>

					<div class="inf-produto">
						<h2 class="titulo-produto" id="titulo-item">Moletom Killua - Unissex</h2>
			...
			<a href="pgCompra.html">
				<figure class="itens">
					<div class="img-item">
						<img src="imagens/produtos/moletons/Filmes/Escolha sua realidade - unissex.png">
					</div>
					<div class="inf-produto">
						<h2 class="titulo-produto" id="titulo-item">Escolha sua Realidade</h2>
						<div class="area-precos">
							<h3 class="preco">R$ 20,00</h3>
						</div>
				</figure>
			...
			<a href="pgCompra.html">
				...
				<figure class="itens">
					<div class="img-item">
						<img src="imagens/produtos/quadros/Animações/Pôster - Rick and Morty.png">
					</div>

					<div class="inf-produto">
						<h2 class="titulo-produto" id="titulo-item">Pôster - Rick and Morty</h2>
						<div class="area-precos">
							<h3 class="preco">R$ 20,00</h3>
						</div>
				</figure>
			...
			<a href="pgCompra.html">
				...
				<figure class="itens">
					<div class="img-item">
						<img src="imagens/produtos/acessorios/Filmes/Mochila - Harry Potter - Flavor.png">
					</div>

					<div class="inf-produto">
						<h2 class="titulo-produto" id="titulo-item">Mochila - Harry Potter</h2>
			...
			<a href="pgCompra.html">
				<figure class="itens">
					<div class="img-item">
						<img src="imagens/produtos/acessorios/Animações/Caneca - Panda.png">
					</div>

					<div class="inf-produto">
						<h2 class="titulo-produto" id="titulo-item">Caneca - Panda</h2>
			...
			<a href="pgCompra.html">
				<figure class="itens">
					<div class="img-item">
						<img src="imagens/produtos/acessorios/Animações/Caneca - Pardo.png">
					</div>

					<div class="inf-produto">
						<h2 class="titulo-produto" id="titulo-item">Caneca - Pardo</h2>
	...
	<section class="banner-tipos" data-aos="fade-up" data-aos-duration="1000">
		...
		<a href="moletons.php" class="banners-link">
		...
		<div class="enquadro">
			<a href="acessorios.html" class="banners-link">
			...
			<a href="infantil.php" class="banners-link">
		...
		<a href="quadros.php" class="banners-link">
		...
		<a href="camisetas.php" class="banners-link">
			<figure class="banner-detalhes" data-aos="zoom-in" data-aos-duration="2000">
